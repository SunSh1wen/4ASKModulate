...
HD_PWD='F:/SSWPersonalData/Project/Vivado/ASKModulate/ASKModulate.runs/xfft_analyze_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xfft_analyze.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xfft_analyze.tcl
